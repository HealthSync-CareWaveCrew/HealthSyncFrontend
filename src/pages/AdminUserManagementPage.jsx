...
import { getAllUsers, toggleUserStatus, deleteUser } from '../Redux/Features/adminSlice';
...
export default function AdminUserManagementPage() {
  ...
  const columns = useMemo(() => [
    { field: 'name', header: 'User Name', type: 'text', filterType: 'text', width: 220 },
    { field: 'email', header: 'Email Address', type: 'text', filterType: 'text', width: 250 },
    { 
      field: 'role', 
      header: 'Role', 
      type: 'status', 
    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex gap-3">
          ...
          >
            {row.isActive ? <MdToggleOn className="text-2xl text-green-500" /> : <MdToggleOff className="text-2xl text-gray-400" />}
          </button>
          <button 
